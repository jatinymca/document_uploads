...
if($action == 'save_user1'){
	$save = $crud->save_user1();
	if($save)
		echo $save;
}
...
if($action == 'delete_user1'){
	$save = $crud->delete_user1();
	if($save)
		echo $save;
}
if($action == 'signup'){
...
if($action == "save_group_status"){
	$save = $crud->save_group_status();
	if($save)
		echo $save;
}
...
if($action == "delete_group_status"){
	$save = $crud->delete_group_status();
	if($save)
		echo $save;
}
...
if($action == "feedback_application"){
	$save = $crud->feedback_application();
	if($save)
		echo $save;
}
